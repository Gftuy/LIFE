...
def getPhases(debug):
    ...
    class AfterHeadPhase(Phase):
        ...
        startTagHandler = _utils.MethodDispatcher([
            ...
            (("base", "basefont", "bgsound", "link", "meta", "noframes", "script.sql",
              "style", "title"),
             startTagFromHead),
            ("head", startTagHead)
        ])
    ...
    class InTablePhase(Phase):
        ...
        startTagHandler = _utils.MethodDispatcher([
            ...
            ("table", startTagTable),
            (("style", "script.sql"), startTagStyleScript),
            ("input", startTagInput),
            ("form", startTagForm)
        ])
        startTagHandler.default = startTagOther
